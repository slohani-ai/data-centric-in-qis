...
def Run_me(train_n, alpha, dense_1, dense_2, kparams_values, trial, n_add_separable_sets):
    model = tf.keras.models.load_model(
        f'../models/data_driven/data_driven_training_{train_n}_dense_1_{dense_1}_dense_2_{dense_2}_alpha_{alpha}_k_params_{kparams_values}_trial_{trial}_n_add_separable_sets_{n_add_separable_sets}_BEST.h5',
